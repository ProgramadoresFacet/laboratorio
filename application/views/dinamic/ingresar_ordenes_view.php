                        ...
                        <form class="form-horizontal form-label-left">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    <input id="nombre" type="text" class="form-control" placeholder="" required="required">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 col-sm-4 col-xs-12" for="tags-medico">Apellido del Médico</label>
                            ...
                            <div class="form-group">
                                <label class="col-md-4 col-sm-4 col-xs-12">Número de Orden</label>
                            ...
                            <div class="form-group">
                                <label class="col-md-4 col-sm-4 col-xs-12">Número de Afiliado</label>
            ...
            <div class="x_panel">
                <div class="x_content">
                    ...
                    <div class="col-md-6 col-xs-12">
                        ...
                        <form class="form-horizontal form-label-left">
                            <div class="form-group">
                                <label class="col-md-4 col-sm-4 col-xs-14" for="tags-analisis">Análisis:</label>
                        ...
                        <div class="x_content">
                            ...
                            <div class="col-md-6 col-xs-12">
                                ...
                                <form class="form-horizontal form-label-left">
                                    ...
                                    <!--div class="form-group">
                                        <label class="col-md-6 col-sm-6 col-xs-14" >Precio Análisis:</label>
